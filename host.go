...
import (
	...
	"github.com/kr/pty"
	"github.com/VaradBelwalkar/webtty/pkg/sd"
...
func (hs *hostSession) run() (err error) {
	...
	if hs.oneWay {
		colorstring.Printf(
			"Warning: One-way connections rely on a third party to connect. " +
				"More info here: https://github.com/VaradBelwalkar/webtty#one-way-connections\n\n")
	}
	...
	colorstring.Printf(`[bold]Paste it in the terminal after the webtty command` +
		"\n[bold]Or in a browser: [reset]https://VaradBelwalkar.github.io/webtty/\n\n")
